  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Add New Tender Notice</h1>
          <p className="text-slate-500 text-sm mt-0.5">Publish a new procurement notification, file, or table grid.</p>
        </div>
      </div>
