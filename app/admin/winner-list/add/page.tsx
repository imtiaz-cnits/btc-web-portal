...
export default function AddWinnerPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <h1 className="text-2xl font-bold text-gray-800">Add New Winner</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-sm border space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2 space-y-2">
            <label className="text-sm font-semibold text-gray-700">Attach Result Document (PDF or Image)</label>
            <input 
              type="file" 
              name="file" 
              accept=".pdf,image/*"
