...
const Hero: React.FC<HeroProps> = () => {
  return (
    <div className="hero bg-secondary overflow-hidden pt-[60px] lg:pt-[80px] pb-[60px] lg:pb-[80px]">
      <div className="custom-container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-[36px] md:text-[52px] lg:text-[64px] font-extrabold text-text-1 mb-[8px] uppercase font-primary leading-tight tracking-tight">
            Building Technology &
            <span className="text-primary"> Consultant </span>
          </h1>
          <h2 className="text-[28px] md:text-[40px] lg:text-[50px] font-bold text-text-1 mb-[30px] uppercase font-primary leading-tight tracking-tight">
            S. Alom EGP
