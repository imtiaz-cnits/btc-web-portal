...
const Services: React.FC = () => {
  return (
    <section id="services" className="offer pt-20">
      <div className="custom-container mx-auto px-4">
        <div className="offer_wrapper relative bg-shade-1 lg:rounded-[80px] rounded-[40px] lg:py-[40px] py-[20px] lg:px-[20px] overflow-hidden">
          {/* Shape 1 SVG */}
          <div className="shape1 absolute left-[-20px] top-[30px] pointer-events-none">
            <svg
              width="179"
              height="243"
              viewBox="0 0 179 243"
          ...
          {/* Shape 2 SVG */}
          <div className="shape2 absolute right-[-20px] top-[30px] pointer-events-none">
            <svg
              width="215"
              height="320"
              viewBox="0 0 215 320"
          ...
          <div className="heading_wrap relative text-center mb-[40px] z-10">
            <span className="tag text-[16px] font-medium font-primary text-secondary bg-primary px-[20px] py-[5px] rounded-[30px] z-10 uppercase">
              WHAT WE OFFER
            </span>
            <h2 className="title text-[32px] font-medium font-primary text-text-1 uppercase pt-[20px] max-w-[680px] mx-auto z-[1]">
          ...
          <div className="flex flex-wrap gap-y-5 lg:gap-y-0">
            ...
            <div className="w-full lg:w-1/3 px-4">
              <div className="offer_card text-center group">
                <div className="icons flex justify-center items-center">
                  <div className="icon relative">
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className="absolute w-[30px] h-[30px] top-0 left-[20px] z-[2]"
                    >
                      <path
                ...
                <h3 className="title text-[18px] font-medium font-primary text-[var(text-1)] uppercase my-[10px]">
                  EGP Registration
                </h3>
                ...
                <div className="button mt-[16px]">
                  <button className="read_more_btn bg-black relative inline-flex items-center gap-2 py-[10px] px-[30px] rounded-tl-none rounded-tr-[12px] rounded-br-[12px] rounded-bl-[12px] border-none cursor-pointer overflow-hidden z-[1] group transition-all duration-400">
                    <span className="text-white transition-all duration-400 font-[var(--secondary-font)] text-[16px] font-semibold">
                      READ MORE
                    </span>
                    <svg
                      width="20"
          ...
          <div className="mt-[36px] flex flex-wrap">
            ...
            <div className="w-full lg:w-1/3 px-4 mb-4 flex items-stretch">
              <div className="offer_details flex items-start bg-[var(--secondary-color)] p-[14px] rounded-[16px] gap-[20px]">
                <div className="icons flex justify-center items-center">
                  <div className="icon relative w-[52px] h-[52px] bg-[linear-gradient(90deg,#5AA469_50%,transparent_50%),linear-gradient(90deg,#5AA469_50%,transparent_50%),linear-gradient(0deg,#5AA469_50%,transparent_50%),linear-gradient(0deg,#5AA469_50%,transparent_50%)] bg-repeat bg-[length:9px_2px,9px_2px,2px_9px,2px_9px] bg-[position:0%_0%,100%_100%,0%_100%,100%_0px] rounded-tl-[12px] rounded-tr-[12px] rounded-br-[12px] p-[10px] mt-[10px] mb-[10px] animate-[dash_5s_linear_infinite] cursor-default z-[1]">
                    <svg
                      width="40"
                ...
                <div className="details_wrap">
                  <div className="title_wrap flex h-[55px] items-center justify-between gap-[10px]">
                    <h3 className="title text-[18px] font-medium font-primary text-[var(text-1)] uppercase m-0">
                      Soil Test
                    </h3>
                    <div className="button">
                      <button className="ar_btn inline-block w-[38px] h-[38px] bg-[var(--text-1)] rounded-bl-[12px] rounded-tl-[0px] rounded-tr-[12px] rounded-br-[12px] p-[6px] transition-all duration-[0.3s] hover:bg-[var(--primary-color)]">
                        <svg
                          width="24"
                          height="24"
                          viewBox="0 0 28 28"
                        ...
                        >
                          <path
                            d="M7 21L21 7M21 7H11.6667M21 7V16.3333"
                            stroke="white"
                            strokeWidth="3"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                  ...
                  <p className="paragraph text-[16px] leading-[20px] !text-left font-normal m-0 font-secondary text-[var(text-1)]">
