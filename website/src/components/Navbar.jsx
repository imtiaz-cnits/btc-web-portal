...
const Navbar = () => {
    return (
        <div>
                    ...
                    <div className="flex justify-between items-center py-2.5 border-b border-b-[var(--ac-1)]">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <a href="tel:01711010929"
                                   className="text-text-1 text-base font-normal font-secondary ml-0.5 hover:text-[var(--primary-color)] transition duration-300">01711010929-(Imran)
                                    , 01711805086-(Shah Alom)</a>
                            </div>
                            ...
                            <div className="flex items-center gap-1">
                                <svg width="20" height="20" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path
                                        ...
                                        fill="#171717" />
                                    <path
                                        d="M19.0854 19.6187L18.152 20.2147C17.5093 20.6206 16.7648 20.836 16.0047 20.836C15.2446 20.836 14.5 20.6206 13.8573 20.2147L12.924 19.6173C12.904 19.636 12.896 19.6613 12.876 19.6787L2.15735 28.86C2.72364 29.166 3.35634 29.3286 4.00002 29.3333H28C28.6441 29.3286 29.2772 29.166 29.844 28.86L19.1334 19.6787C19.112 19.6613 19.104 19.636 19.0854 19.6187Z"
                                        fill="#171717" />
                                </svg>
                                <a href="mailto:info@egpbtc.com"
                                   className="text-text-1 text-base font-normal font-secondary ml-0.5 hover:text-[var(--primary-color)] transition duration-300">info@egpbtc.com</a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-6">
                            <a href="https://www.facebook.com/share/16cBeKdBrD/"
                               className="hover:text-[var(--primary-color)] transition duration-400">
                                <i
                                    className="fa-brands fa-facebook-f text-text-1 text-xl hover:text-[var(--primary-color)] transition duration-400"></i>
                            </a>
                            <a href="#" className="hover:text-[var(--primary-color)] transition duration-400">
                                <i
                                    className="fa-brands fa-instagram text-text-1 text-xl hover:text-[var(--primary-color)] transition duration-400"></i>
                            </a>
                            <a href="#" className="hover:text-[var(--primary-color)] transition duration-400">
                                <i
                                    className="fa-brands fa-x-twitter text-text-1 text-xl hover:text-[var(--primary-color)] transition duration-400"></i>
                            </a>
                            <a href="#" className="hover:text-[var(--primary-color)] transition duration-400">
                                <i
                                    className="fa-brands fa-linkedin-in text-text-1 text-xl hover:text-[var(--primary-color)] transition duration-400"></i>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="w-full border-b border-b-[var(--ac-1)]">
                        <div className="flex justify-between h-[80px] items-center">
                            ...
                            <div className="hidden lg:flex space-x-6 items-center">
                                ...
                                <a href="#"
                                   className="text-[var(--text-1)] hover:text-[var(--primary-color)] transition duration-400 font-medium">SERVICES</a>
                                <a href="#"
                                   className="text-[var(--text-1)] hover:text-[var(--primary-color)] transition duration-400 font-medium">TENDER</a>
                                <a href="#"
                                   className="text-[var(--text-1)] hover:text-[var(--primary-color)] transition duration-400 font-medium">PROJECTS</a>
                                ...
                                <div className="relative dropdown group">
                                    ...
                                    <div className="dropdown-content absolute mt-2 w-56 border border-[var(--ac-2)] rounded-lg shadow-lg">
                                        <a href="./notice.html" className="block px-4 py-2 hover:bg-[var(--primary-color)]">NOTICE</a>
                                        <a href="#" className="block px-4 py-2 hover:bg-[var(--primary-color)]">GALLERY</a>
                                    {/*    -- <div className="relative has-sub-dropdown group">*/}
                                    {/*    <div*/}
                                    {/*        className="flex justify-between items-center px-4 py-2 hover:bg-[var(--primary-color)] cursor-pointer"*/}
                                    {/*    >*/}
                                    {/*        GALLERY*/}
                                    {/*        <svg*/}
                                    {/*            className="w-4 h-4 ml-2 rotate-sub-icon"*/}
                                    {/*            fill="none"*/}
                                    {/*            stroke="currentColor"*/}
                                    {/*            viewBox="0 0 24 24"*/}
                                    {/*        >*/}
                                    ...
                                    {/*    </div>*/}
                                    {/*    <div*/}
                                    {/*        className="sub-dropdown-content absolute ml-1 w-56 bg-[var(--secondary-color)] border border-gray-200 rounded-lg shadow-lg"*/}
                                    {/*    >*/}
                                    {/*        <a*/}
                                    {/*            href="#"*/}
                                    {/*            className="block px-4 py-2 text-sm hover:bg-[var(--primary-color)]"*/}
                                    {/*        >Text 1</a*/}
                                    {/*        >*/}
                                    {/*        <a*/}
                                    {/*            href="#"*/}
                                    ...
                                    {/*    </div>*/}
                                    {/*</div> -->*/}
                                        <a href="#" className="block px-4 py-2 hover:bg-[var(--primary-color)]">BLOG</a>
                                        <a href="#" className="block px-4 py-2 hover:bg-[var(--primary-color)]">PRIVACY POLICY</a>
                                        <a href="#" className="block px-4 py-2 hover:bg-[var(--primary-color)]">TERMS & CONDITIONS</a>
                                    </div>
                                </div>

                                <a href="./about.html"
                                   className="text-[var(--text-1)] hover:text-[var(--primary-color)] transition duration-400 font-medium">ABOUT
                                    US
                                </a>
              ...
              <span
                  className="absolute bottom-0 left-0 right-0 h-0 transition-all duration-500 ease-out bg-[var(--text-1)] group-hover:h-full"></span>
                            ...
                            <div className="lg:hidden">
                                <button id="menu-btn" className="text-[var(--text-1)] cursor-pointer">
                                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5.5 22H38.5M5.5 11H38.5M5.5 33H27.5" stroke="#c26c2a" strokeWidth="3" strokeLinecap="round"
            ...
            {/* Mobile Menu Start */}
            <div id="mobile-menu"
                 className="fixed overflow-auto top-0 left-0 h-full w-64 bg-[var(--secondary-color)] shadow-lg transform -translate-x-full transition-transform duration-300 ease-in-out z-[52] lg:hidden">
                <div className="flex justify-between items-center px-4 py-3 border-b">
                    <a href="./index.html" className="text-xl font-bold">
                        <img className="w-[100px] object-contain" src="./assets/icon/Logo.svg" alt="" />
                    </a>
                    <button id="close-menu" className="text-[var(--text-1)] cursor-pointer">
                ...
                <div className="px-4 py-2 space-y-1">
                    <a href="#"
                       className="block px-3 py-2 text-[var(--text-1)] bg-[var(--shade-1)] active:bg-[var(--shade-1)] rounded-lg">HOME</a>
                    <a href="#" className="block px-3 py-2 text-[var(--text-1)] hover:bg-[var(--shade-1)] rounded-lg">SERVICES</a>
                    <a href="#" className="block px-3 py-2 text-[var(--text-1)] hover:bg-[var(--shade-1)] rounded-lg">TENDER</a>
                    <a href="#" className="block px-3 py-2 text-[var(--text-1)] hover:bg-[var(--shade-1)] rounded-lg">PROJECTS</a>
                    ...
                    <div>
                        <button
                            ...
                            PAGES
                            <svg className="mobile-dropdown-icon w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div className="mobile-dropdown bg-[var(--text-1)] rounded-lg">
                            <a href="./notice.html"
                               className="block px-3 py-2 text-[14px] text-[var(--secondary-color)] hover:bg-[var(--primary-color)]">NOTICE</a>
                        {/*    <!-- <div>*/}
                        {/*    <button*/}
                        {/*        className="sub-mobile-dropdown-btn flex justify-between items-center w-full px-3 py-2 text-[var(--text-1)] hover:bg-[var(--primary-color)] rounded"*/}
                        {/*    >*/}
                        {/*        Page 2*/}
                        {/*        <svg*/}
                        {/*            className="mobile-dropdown-icon w-4 h-4 ml-2"*/}
                        {/*            fill="none"*/}
                        {/*            stroke="currentColor"*/}
                        {/*            viewBox="0 0 24 24"*/}
                        {/*        >*/}
                        ...
                        {/*        </svg>*/}
                        {/*    </button>*/}
                        {/*    <div className="sub-mobile-dropdown pl-4">*/}
                        {/*        <a*/}
                        {/*            href="#"*/}
                        {/*            className="block px-3 py-1 text-sm text-[var(--text-1)] hover:bg-[var(--primary-color)] rounded"*/}
                        {/*        >Text 1</a*/}
                        {/*        >*/}
                        {/*        <a*/}
                        {/*            href="#"*/}
                        ...
                        {/*</div> -->*/}
                            <a href="#"
                               className="block px-3 py-2 text-[14px] text-[var(--secondary-color)] hover:bg-[var(--primary-color)]">GALLERY</a>
                            <a href="#"
                               className="block px-3 py-2 text-[14px] text-[var(--secondary-color)] hover:bg-[var(--primary-color)]">BLOG</a>
                            <a href="#"
                               className="block px-3 py-2 text-[14px] text-[var(--secondary-color)] hover:bg-[var(--primary-color)]">PRIVACY
                                POLICY</a>
                            <a href="#"
                               className="block px-3 py-2 text-[14px] text-[var(--secondary-color)] hover:bg-[var(--primary-color)]">TERMS &
                                CONDITIONS</a>
                        </div>
                    </div>

                    <a href="./about.html" className="block px-3 py-2 text-[var(--text-1)] hover:bg-[var(--shade-1)] rounded-lg">ABOUT
                        US</a>
                </div>
          ...
          <span
            ...
            <div id="menu-overlay" className="fixed top-0 left-0 w-full h-full bg-[#00000036] z-[51] hidden"></div>
            { /* Mobile Menu End */}
        </div>
    );
};
