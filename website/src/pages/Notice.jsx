                            ...
                            <table className="min-w-full border border-[var(--ac-1)] w-full">
                                ...
                                {loading ? (
                                    ...
                                    currentNotices.map((notice, index) => (
                                        <tr key={notice._id} className="hover:bg-[var(--shade-1)] border border-[var(--ac-1)]">
                                            ...
                                            <td className="px-6 py-4 text-center whitespace-nowrap border border-[var(--ac-1)]">
                                                <button
                                                    className="bg-[var(--primary-color)] hover:bg-green-600 text-[var(--secondary-color)] px-4 py-2 rounded-md transition-colors"
                                                    onClick={() => handleViewPdf(notice.filePath)}
                                                    disabled={!notice.filePath}
                                                >
                                                    Download
                                                </button>
                                            </td>
